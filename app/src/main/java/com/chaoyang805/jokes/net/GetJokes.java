...
public class GetJokes {
     ...
     * @param limit    请求笑话的数量
     */
    public GetJokes(final CallBack callBack, int limit) {
        String[] paramsName = {Constant.REQUEST_TYPE, Constant.LIMIT};
        String[] paramsValues = {Constant.GET_JOKES, String.valueOf(limit)};
        //实例化一个网络基础类的对象
